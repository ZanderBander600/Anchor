...
def test_the_migration_reaches_the_current_schema_version(migrated) -> None:
    ...
    assert version == 15  # P7.4: eight Strategy tables; P7.6: five sidecars; P7.8B: six Capital Structure tables; P7.9 Stage 2: eight Partnership tables; AM1: two Asset Management tables; Asset Types 1: two classification tables, all purely additive
...
def test_the_migration_is_idempotent(migrated) -> None:
    ...
    assert version == 15  # Asset Types 1; see test_the_migration_reaches_the_current_schema_version
    assert suites == 0
