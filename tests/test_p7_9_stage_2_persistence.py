...
def test_a_fresh_store_is_schema_12_with_eight_empty_partnership_tables(db: Path) -> None:
    ...
    # valuation and Investment Memo tables; P7.10 Stage 4 schema 16's one
    # immutable report-artifact table. P7.9's own eight are unchanged by all
    # four, which is what this test is about.
    assert version == 16
